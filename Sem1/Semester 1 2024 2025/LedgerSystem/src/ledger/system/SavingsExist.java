 ...
 * @author nitrom
 */
public class SavingsExist extends Savings_Menu {
    SavingsExist(String user_id, String name){
         super(user_id,name);
        ...
        JLabel question = new JLabel(
                ...
                + "    <span style='font-size: 24px; font-weight: bold;'> You've saved RM" + Savings.accumulated_savings + " thus far!</span>\n"
                + "    <br>\n"
                + "    <span style='font-size: 18px;'>Keep the good work up!</span>\n"
                + "    <br>\n"
                + "    <span style='font-size: 18px;'>Current savings percentage is " + Savings.percentage + "% </span>\n"
                + "  </div>\n"
                + "</html>");
